...
const Footer: React.FC = () => {
  return (
    <footer className="relative bg-blueGray-200 pt-8 pb-6 border-t-2 border-gray-200">
          ...
          <div className="w-full lg:w-6/12 px-4">
            ...
            <div className="mt-6 lg:mb-0 mb-6">
              <button
                ...
                type="button"
              >
                <BsTwitter className="mx-auto h-6 w-6" />
              </button>
              <button
                className="bg-white text-blue-600 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2"
                type="button"
              >
                <FaFacebook className="mx-auto h-6 w-6" />
              </button>
              <button
              ...
              <button
                ...
                type="button"
              >
                <AiFillGithub className="mx-auto h-6 w-6" />
              </button>
            </div>
          </div>
          <div className="w-full lg:w-6/12 px-4">
